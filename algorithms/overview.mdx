...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="brain"
    href="/algorithms/design-techniques/divide-and-conquer"
  >
...
<Card title="Explore Sorting Algorithms" icon="arrow-down-1-9" href="/algorithms/sorting/bubble-sort">
...
<Card title="Explore Searching Algorithms" icon="magnifying-glass" href="/algorithms/searching/linear-search">
...
<Card title="Explore Graph Algorithms" icon="network-wired" href="/algorithms/graph/dijkstra">
...
<Card title="Explore Design Techniques" icon="brain" href="/algorithms/design-techniques/divide-and-conquer">
...
<CardGroup cols={2}>
  <Card title="Sorting Algorithms" icon="arrow-down-1-9" href="/algorithms/sorting/bubble-sort">
    Start with fundamental sorting techniques
  </Card>
  
  <Card title="Searching Algorithms" icon="magnifying-glass" href="/algorithms/searching/linear-search">
    Learn efficient search strategies
  </Card>
  
  <Card title="Graph Algorithms" icon="network-wired" href="/algorithms/graph/dijkstra">
    Explore pathfinding and traversal
  </Card>
  
  <Card title="Design Techniques" icon="brain" href="/algorithms/design-techniques/divide-and-conquer">
